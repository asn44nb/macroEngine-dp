# ============================================
# macro:tick/hud_systems — Otomatik HUD Systems
# ============================================
# Flag: #m_hud macro.Flags
# - Auto-HUD: if macro:engine pb_obj is set, progress_bar_self automatically runs every tick
...
# $epoch % 1 = always 0, so it runs every tick — opentionbar never disappears
