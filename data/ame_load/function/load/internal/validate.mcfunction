...
# ─── Global storage init ───────────────────────────────
execute unless data storage macro:engine global run data modify storage macro:engine global set value {version:"v2.0.3-pre1"}
...
execute unless data storage macro:engine global{version:"v2.0.3-pre1"} run data modify storage macro:names temp.vers set value "V2.0.3-pre1"
execute unless data storage macro:engine global{version:"v2.0.3-pre1"} run tellraw @a [{"text":"[AME] ","color":"aqua","bold":true},{"text":"Version mismatch — expected ","color":"red"},{"storage":"macro:names","nbt":"temp.vers","color":"yellow"},{"text":".","color":"red"}]
execute unless data storage macro:engine global{version:"v2.0.3-pre1"} run return 0
