...
# ─── Broadcast warning ────────────────────────────────────
tellraw @a ["",{"text":"[AME] ","color":"#00AAAA","bold":true},{"text":"✘ ","color":"red"},{"text":"Version conflict! ","color":"red","bold":true},{"text":"Expected ","color":"#555555"},{"text":"v2.0.3-pre3","color":"aqua","bold":true},{"text":" — stored scores do not match.","color":"#555555"}]
