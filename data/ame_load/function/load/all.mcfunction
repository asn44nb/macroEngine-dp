...
tellraw @a[tag=macro.debug] {"text":"[Macro Engine v1.0.6-pre4] Loaded.","color":"green"}
...
data modify storage macro:input level set value "Advanced Macro Engine v1.0.6-pre4"
