...
# If already present, "objectives add" silently fails — safe.
# ============================================
...
# Tick-safe guard: stores the last processed epoch value per entity
...
# entity targeting in perm/* instead of @a[name=...] (duplicate-name safe).
scoreboard objectives add macro.pid dummy

# ============================================
# Flag System - Controls Tick Categories
# ============================================
scoreboard objectives add macro.Flags dummy {"text":"Macro Flags","color":"gold"}

# Flag initial values (1 = active, 0 = disabled)
